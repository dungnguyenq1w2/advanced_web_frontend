...
import { MCheckbox } from 'modules/presentation-slide/components'
    ...
    const slide = useMemo(() => {
        return data?.id
            ? {
                  ...
                  data: {
                      labels: data.choices.map((e) => e.content),
                      datasets: [
                          {
                              data: data.choices.map((e) => e.n_choices),
                              backgroundColor: [
                                  getRandomColor(),
                                  getRandomColor(),
                                  getRandomColor(),
        ...
        <>
            {!permission ? (
                ...
                <div className="flex h-[90%] items-center justify-center">
                    <h1 className="absolute top-20 px-6 text-[3.5rem] font-medium">
                        {data.question}?
                    </h1>
                    <MCheckbox
