...
const MChatboxModalSession = ({ isOpen, onClose, data, set, presentationId }) => {
    ...
    const handlePostMessage = async (e) => {
        ...
        messageSocket.emit('client-send-message-session', presentationId, message)
                            ...
                            >
                                ...
                                {messages.length === 1 ? (
                                    ...
                                    >
                                        ...
                                        >
                                            {messages[0].user ? messages[0].user.name : 'Anonymous'}
                                        </span>
...
export default MChatboxModalSession
